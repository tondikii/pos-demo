...
export function Icon(props: {
  ...
  const paths: Record<string, JSX.Element> = {
    ...
    mug: <><path d="M4 9h12v6a4 4 0 01-4 4H8a4 4 0 01-4-4z" /><path d="M16 10h2a2 2 0 010 5h-2" /></>,
    glass: <><path d="M7 3h10l-1 15a3 3 0 01-6 0z" /><path d="M7 8h10" /></>,
    cookie: <><circle cx="12" cy="12" r="8" /><circle cx="9" cy="9" r="0.8" /><circle cx="15" cy="11" r="0.8" /><circle cx="11" cy="16" r="0.8" /></>,
    qrcode: <><rect x="3" y="3" width="7" height="7" rx="1" /><rect x="14" y="3" width="7" height="7" rx="1" /><rect x="3" y="14" width="7" height="7" rx="1" /><path d="M14 14h3v3h-3zM21 14v.01M14 21v.01M21 21v.01" /></>,
    bank: <><path d="M3 9l9-6 9 6" /><path d="M3 9v3M21 9v3" /><path d="M5 12v7M9.5 12v7M14.5 12v7M19 12v7" /><path d="M3 21h18" /></>,
