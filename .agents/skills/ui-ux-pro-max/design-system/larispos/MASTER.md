...
- 4 / 8 / 12 / 16 / 24 / 32 / 48.
- Card padding: 16-24. Section gap: 24-32. Page gutter: 16 (mobile) / 24 (desktop).
...
- **Button:** primary (biru, radius 10, padding 10-16), success (hijau, untuk aksi kasir), outline, ghost. Height ≥40 (mobile ≥48).
- **Card:** surface putih, border 1px `#E2E8F0`, radius 12-16, shadow lembut.
- **Badge:** soft background (primary-soft/success-soft/destructive-soft) + teks warna solid, radius full.
