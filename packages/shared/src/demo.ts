...
export const DEMO_OUTLETS: DemoOutlet[] = [
  { id: 'b6f5c8a1-2d3e-4f5a-9b8c-7d6e5f4a3b21', name: 'Kopi Senja — Tebet', address: 'Jl. Tebet Raya No. 27, Jakarta Selatan' },
  { id: 'c7a6d9b2-3e4f-5a6b-8c9d-0e1f2a3b4c32', name: 'Kopi Senja — Blok M', address: 'Jl. Melawai Raya No. 5, Jakarta Selatan' },
  { id: 'd8b7eac3-4f5a-6b7c-9d0e-1f2a3b4c5d43', name: 'Kopi Senja — Kemang', address: 'Jl. Kemang Raya No. 88, Jakarta Selatan' },
]
...
export const DEMO_CASHIERS: DemoCashier[] = [
  { id: 'stf-kopi-senja-tebet', name: 'Raka Prasetyo', outletId: DEMO_OUTLETS[0].id, pin: '123456' },
  { id: 'stf-kopi-senja-blokm', name: 'Sari Wulandari', outletId: DEMO_OUTLETS[1].id, pin: '123456' },
  { id: 'stf-kopi-senja-kemang', name: 'Dimas Saputra', outletId: DEMO_OUTLETS[2].id, pin: '123456' },
]
...
export const DEMO_PRODUCTS: DemoProduct[] = [
  ...
  },
  {
    ...
    category: 'Minuman',
    costPrice: 7000,
    variants: variants('9a1f5c2e-0000-4000-8000-000000000009', sml(18000, 22000, 25000), 30),
  },
  {
